...
namespace nn.ec
{
    ...
    public sealed class AsyncRecoverRightDataRequest : ConsumableServiceItemAsyncRequestBase
    {
        ...
        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_ec_AsyncRecoverRightDataRequest_Begin")]
        private static extern Result Begin(IntPtr asyncGetConsumableRightDataRequestBase);

        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_ec_AsyncRecoverRightDataRequest_End")]
        private static extern Result End(IntPtr asyncGetConsumableRightDataRequestBase);

        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_ec_AsyncRecoverRightDataRequest_New")]
        private static extern void New(ref IntPtr asyncGetConsumableRightDataRequestBase);

        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_ec_AsyncRecoverRightDataRequest_Delete")]
        private static extern void Delete(IntPtr asyncGetConsumableRightDataRequestBase);
    }

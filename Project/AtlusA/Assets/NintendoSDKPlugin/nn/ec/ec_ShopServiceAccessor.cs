...
namespace nn.ec
{
    ...
    public sealed partial class ShopServiceAccessor : IDisposable
    {
        ...
        {
            return ShopServiceAccessor.IsAvailable(_shopServiceAccessor);
        }
        ...
        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_ec_ShopServiceAccessor_IsAvailable")]
        [return: MarshalAs(UnmanagedType.U1)]
        private static extern bool IsAvailable(IntPtr shopServiceAccessor);

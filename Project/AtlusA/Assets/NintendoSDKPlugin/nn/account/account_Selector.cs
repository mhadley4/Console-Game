...
namespace nn.account
{
    ...
    public static partial class Account
    {
        ...
        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_account_ShowLicenseRequirementsForNetworkService")]
        public static extern Result ShowLicenseRequirementsForNetworkService(UserHandle handle);
#endif
        ...
        public static Result ShowLicenseRequirementsForNetworkService(UserHandle handle, bool suspendUnityThreads)
        {
            ...
            {
                UnityEngine.Switch.Applet.Begin();
                Result result = ShowLicenseRequirementsForNetworkService(handle);
                UnityEngine.Switch.Applet.End();
                return result;
            }
#endif
